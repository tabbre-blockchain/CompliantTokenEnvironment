...
/**
 * @title  On-chain ComplianceService implementation for approving trades
 * @author Bob Remeika
 */
contract TokenComplianceService is ComplianceService, Ownable {
  /**
  ...
  function TokenComplianceService() public {
    admin = msg.sender;
  }
  ...
  /**
   * @notice Retrieves the whole token value from a token that this `ComplianceService` manages
   *
