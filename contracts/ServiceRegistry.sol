...
/// @notice A service that points to a `ComplianceService`
contract ServiceRegistry is Ownable {
   ...
   * @notice Constructor
   *
   * @param _service The address of the `ComplianceService`
   *
   */
  ...
  /**
   * @notice Replaces the address pointer to the `ComplianceService`
   *
   * @dev This method is only callable by the contract's owner
   *
   * @param _service The address of the new `ComplianceService`
   */
